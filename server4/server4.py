...
parser.add_argument("-f", "--port", help = "Port number.", type=int, default = 12348)
parser.add_argument("-p", "--path_to_file", help = "Location of file (complete path without file name).", type = str, default = "C:\\Users\\Deedahwar\\Desktop\\server4")
